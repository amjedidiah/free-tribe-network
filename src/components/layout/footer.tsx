        ...
        <div className="container grid gap-6 lg:gap-8 text-white">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-1">
            <div className="flex max-sm:flex-col items-center gap-2">
              <a
                href={`${process.env.NEXT_PUBLIC_WORDPRESS_ENDPOINT}/wp-content/uploads/2024/06/TERMS-AND-CONDITIONS.pdf`}
              >
                {t("Footer.Terms")}
              </a>{" "}
              ...
              <span className="max-sm:hidden">{"|"}</span>
              <a
                href={`${process.env.NEXT_PUBLIC_WORDPRESS_ENDPOINT}/wp-content/uploads/2024/06/COOKIE-POLICY.pdf`}
              >
                {t("Footer.Cookie")}
              </a>
            </div>
